        ...
        <div className='overflow-auto h-full p-4 scrollbar-hide'>
            ...
            <div>
                ...
                <div>
                    ...
                    {selectedPublication.disciplines.map((discipline, index) => <div key={index} className={labelClassName}>{discipline}</div>)}
                    {selectedPublication.keywords.map((keyword, index) => <div key={index} className={labelClassName}>{keyword}</div>)}
